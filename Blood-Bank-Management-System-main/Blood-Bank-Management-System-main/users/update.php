...
<?php
    include "../common/connection.php";
            ...
            if(isset($_POST['update'])){
                ...
                $updatequery = "update donor set Username='$usrnm', Fname='$fname', Mname='$mname', Lname='$lname', Gender='$sex', Bloodgroup='$bType', Bdate='$dob', Address='$address', City='$city', Dondate='$donationDate', Stats='$stats', Temp='$temp', Pulse='$pulse', Bp='$bp', Weight='$weight', Hemoglobin='$hemoglobin', Hbsag='$hbsag', Aids='$aids', MalariaSmear='$malariaSmear', Hematocrit='$hematocrit', Mobile1='$mobile', Mobile2='$phone' where Username = '$usrnm'";
